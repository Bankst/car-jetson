...
DESCRIPTION = "Formats the NVMe UDA partition on first boot, mounts \
it at /data, and bind-mounts persistent paths (bluetooth, ssh) so they \
survive rootfs reflash."
LICENSE = "MIT"
...
SYSTEMD_SERVICE:${PN} = "banks-persist-setup.service data.mount banks-persist-bind.service"
